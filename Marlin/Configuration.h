...
#define STRING_CONFIG_H_AUTHOR "(Lazar, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mankati Forever"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT {78.7402, 78.7402, 800, 610} 
...
//#define Z_SAFE_HOMING
    ...
    #define Z_SAFE_HOMING_Y_POINT (1)    // Y point for Z homing when homing all axes (G28).
#endif
